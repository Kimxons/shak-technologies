...
; (function (global) {
  ...
  async function loadGroupLoanSanctionService() {
  await loadCore();
  await loadScript(assetUrl('services/workflow/groupLoanSanctionService.js'));
}
  /**
  ...
  /**
   * Load group pending application service (workflow)
   * @returns {Promise} Resolves when group pending application service is loaded
   */
  async function loadGroupPendingApplicationService() {
    await loadCore();
    await loadScript('/assets/js/services/workflow/groupPendingApplicationService.js');
  }
  ...
  /**
   * Load Refinance Initiation service
   * @returns {Promise} Resolves when Refinance Initiation service is loaded
   */
  async function loadRefinanceInitiationService() {
    await loadCore();
    await loadScript('/assets/js/services/loans/refinanceInitiationService.js');
   /* Load guarantors service (workflow/guarantors)
   * @returns {Promise} Resolves when guarantors service is loaded
   */
  }
  async function loadGuarantorsService() {
    await loadCore();
    await loadScript('/assets/js/services/workflow/guarantorsservice.js');
  }
  ...
  /**
   * Load AI service
   * @returns {Promise} Resolves when AI service is loaded
   */
  async function loadAiService() {
    await loadCore();
    await loadScript(assetUrl('services/ai/aiService.js'));
  }
