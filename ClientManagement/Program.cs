...
using ClientManagement.Modules.ClientMaintenance;
using ClientManagement.Modules.Shared;
...
try
{
    ...
    builder.Services.AddScoped<IClientBasicDetailsRepo, ClientMaintenanceRepo>();
    builder.Services.AddScoped<IClientAddressRepo, ClientAddressRepo>();
    builder.Services.AddScoped<IClientDocumentsRepo, ClientDocumentsRepo>();
    builder.Services.AddScoped<IClientRelationsRepo, ClientRelationsRepo>();
    ...
    builder.Services.AddScoped<IClientProductAndServicesRepo, ClientProductAndServicesRepo>();
    builder.Services.AddScoped<IClientOtherDetailsRepo, ClientOtherDetailsRepo>();
    builder.Services.AddScoped<IClientSpecialOffersRepo, ClientSpecialOffersRepo>();
