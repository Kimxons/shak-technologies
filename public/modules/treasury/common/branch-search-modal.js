(function (global) {
    ...
    async function onSearch() {
        ...
        if (tableBody) tableBody.innerHTML = '<tr><td colspan="2" class="text-center">Searching...</td></tr>';
        ...
        tableBody.innerHTML = rows.map((row) => {
            ...
            return `
                <tr data-row="${jsonData}">
                    <td>${row.BranchId || row.BranchID || ''}</td>
    ...
    function renderError(msg) {
        if (tableBody) tableBody.innerHTML = `<tr><td colspan="2" class="text-center" style="color:red">${msg}</td></tr>`;
    }
    ...
    function onConfirmSelection() {
        ...
        window.parent.postMessage({
            ...
            branchId: selectedData.BranchId || selectedData.BranchID,
            branchName: selectedData.BranchName || selectedData.Name,
            data: selectedData
        }, '*');
