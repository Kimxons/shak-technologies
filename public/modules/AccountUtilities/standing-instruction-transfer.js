(() => {
  const form = document.querySelector(".sitx-form");
  if (!form) return;
  ...
  const editableSelector = ".sitx-input:not([readonly]), .sitx-select";
  ...
  const setEditMode = (isEditing) => {
    ...
    // Stop/Print are available in view mode only.
  ...
  document.querySelectorAll(".sitx-btn-lookup").forEach((btn) => {
  ...
  document.querySelectorAll(".sitx-title-btn").forEach((btn) => {
    btn.addEventListener("click", () => {
