(() => {
  const form = document.querySelector(".sidd-form");
  if (!form) return;
  ...
  const editableSelector = ".sidd-input:not([readonly]), .sidd-select";
  ...
  document.querySelectorAll(".sidd-btn-lookup").forEach((btn) => {
  ...
  document.querySelectorAll(".sidd-title-btn").forEach((btn) => {
    btn.addEventListener("click", () => {
