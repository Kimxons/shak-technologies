(() => {
  ...
  function populateBehindTheScene(data) {
    ...
    if (createdBy) createdBy.value = data?.CreatedBy || data?.createdBy || "";
    if (createdOn) createdOn.value = data?.CreatedOn || data?.createdOn || "";
    if (supervisedBy) supervisedBy.value = data?.SupervisedBy || data?.supervisedBy || "";
    if (supervisedOn) supervisedOn.value = data?.SupervisedOn || data?.supervisedOn || "";
  }
