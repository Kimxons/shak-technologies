  ...
  async function handleSearchOrView() {
    ...
    try {
      ...
      if (resp && resp.data && resp.data.length > 0) {
        ...
        qs("#InsuranceCode").value = data.InsuranceCode || data.insurancecode || data.Code || id;
        qs("#Description").value = data.Description || data.description || "";
        qs("#IsActive").checked = !!(data.Status || data.status || data.IsActive || data.isactive);
        qs("#CreatedBy").value = data.CreatedBy || data.createdby || "";
        qs("#CreatedOn").value = data.CreatedOn || data.createdon || "";
        qs("#ModifiedBy").value = data.ModifiedBy || data.modifiedby || "";
        qs("#ModifiedOn").value = data.ModifiedOn || data.modifiedon || "";
